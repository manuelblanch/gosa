...
<div class="plugin-actions">
  <img src="plugins/highschoolusers/images/pdficon.jpeg" width="25" height="25" alt="Print PDF" border="0" align="absmiddle" />
  <button type='submit' id='print_enrolment' name='print_enrolment' accesskey="p">{t}Print Enrolment & Save{/t}</button>
  <button type='submit' id='password_finish'name='password_finish' accesskey="s">{t}Set password{/t}</button>
  <button type='submit' id='password_cancel'name='password_cancel' accesskey="c">{msgPool type=cancelButton}</button>
</div>
